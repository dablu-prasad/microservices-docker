...
const emailVerify = (token) => {
    return ('<html xmlns="http://www.w3.org/1999/xhtml">' +
        ...
        `              <h1><img src="${process.env.SERVER_URL}${commonConstants_1.commonConstants.TEAM_NAME}" alt="${commonConstants_1.commonConstants.TEAM_NAME}"></h1>` +
        "            </td>" +
        "          </tr>" +
        "          <tr>" +
        '            <td class="content">' +
        ...
        `              <p>Your ${commonConstants_1.commonConstants.TEAM_NAME} team</p>` +
        "            </td>" +
        "          </tr>" +
        "        </table>" +
        "      </td>" +
...
//# sourceMappingURL=email-verify.html.js.map